...
ARG TZ='Etc/UTC'
ARG KASMVNC_COMMIT_ID=''
ARG KASMVNC_VER=''
ARG KASMVNC_BRANCH=master
ARG PROFILE_SYNC_V2_COMMIT_ID=''
ARG PROFILE_SYNC_V2_BRANCH=''
ENV DEBIAN_FRONTEND=noninteractive \
    DISTRO=$DISTRO \
    KASMVNC_COMMIT_ID=$KASMVNC_COMMIT_ID \
    KASMVNC_BRANCH=$KASMVNC_BRANCH \
    KASMVNC_VER=$KASMVNC_VER \
    PROFILE_SYNC_V2_COMMIT_ID=$PROFILE_SYNC_V2_COMMIT_ID \
    PROFILE_SYNC_V2_BRANCH=$PROFILE_SYNC_V2_BRANCH \
